...
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright
Buysse, D.J., Reynolds III, C.F., Monk, T.H., Berman, S.R., \& Kupfer, D.J. (1989). The Pittsburgh Sleep Quality Index: A new instrument for psychiatric practice and research. Journal of Psychiatric Research, 28(2), 193-213.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.22\columnwidth}\raggedright
timeline\strut
\end{minipage} & \begin{minipage}[t]{0.27\columnwidth}\raggedright
